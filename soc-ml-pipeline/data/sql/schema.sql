...
/* v_rf_enriched(id,rf_pred,rf_score,scored_at,rule_level,timestamp) */;
...
/* v_paired_eval(id,true_label,rf_prediction,wazuh_prediction,timestamp) */;
CREATE TABLE paired_eval_fast (
  id TEXT,
  true_label INTEGER,
  rf_prediction INTEGER,
  wazuh_prediction INTEGER,
  timestamp TEXT,
  day TEXT
);
CREATE TABLE true_labels(id,true_label);
CREATE UNIQUE INDEX ux_true_labels_id ON true_labels(id);
CREATE TABLE alerts_enriched_norm(
  id,
  rule_level INT,
  rule_description TEXT,
  timestamp TEXT,
...
CREATE TABLE alerts_enriched_by_id(
  id,
  rule_level INT,
  rule_description TEXT,
  timestamp TEXT,
